...
public class CRFClassifier<IN extends CoreMap> extends AbstractSequenceClassifier<IN> {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String textFolder = flags.textFolder;
    String outputFolder = flags.outputFolder;
    ...
    if (textFolder != null) {
      ...
      for (File file : listOfFiles) {
        crf.classifyAndWriteAnswers(file.getPath(),
new FileOutputStream(new File(outputFolder, file.getName())),
crf.plainTextReaderAndWriter(),
false
);
      }
    }
